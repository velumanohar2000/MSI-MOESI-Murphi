...
class mu_1_h_state: public mu__byte
{
 public:
  ...
  mu_1_h_state (char *name, int os): mu__byte(7, 14, 4, name, os) {};
  mu_1_h_state (void): mu__byte(7, 14, 4) {};
  mu_1_h_state (int val): mu__byte(7, 14, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1_h_state::values[] = {"H_I","H_S","H_M","H_E","H_MSD","H_MMD","H_SMA","H_IE",NULL };
...
class mu_1_p_state: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_p_state::values[ int(val) - 15] );
    else return ( s << "Undefined" );
  };

  mu_1_p_state (char *name, int os): mu__byte(15, 27, 4, name, os) {};
  mu_1_p_state (void): mu__byte(15, 27, 4) {};
  mu_1_p_state (int val): mu__byte(15, 27, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1_p_state::values[] = {"P_I","P_S","P_M","P_E","P_ISD","P_IMAD","P_IMA","P_SMAD","P_SMA","P_MIA","P_EIA","P_SIA","P_IIA",NULL };
...
class mu_1_MessageType: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_MessageType::values[ int(val) - 28] );
    else return ( s << "Undefined" );
  };

  mu_1_MessageType (char *name, int os): mu__byte(28, 41, 4, name, os) {};
  mu_1_MessageType (void): mu__byte(28, 41, 4) {};
  mu_1_MessageType (int val): mu__byte(28, 41, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1_MessageType::values[] = {"GetM","GetMAck","GetS","GetSAck","FwdGetM","FwdGetS","Inv","InvAck","PutM","PutE","PutS","PutAck","InvAckAll","EAck",NULL };
...
const int mu_H_M = 9;
const int mu_H_E = 10;
const int mu_H_MSD = 11;
const int mu_H_MMD = 12;
const int mu_H_SMA = 13;
const int mu_H_IE = 14;
const int mu_P_I = 15;
const int mu_P_S = 16;
const int mu_P_M = 17;
const int mu_P_E = 18;
const int mu_P_ISD = 19;
const int mu_P_IMAD = 20;
const int mu_P_IMA = 21;
const int mu_P_SMAD = 22;
const int mu_P_SMA = 23;
const int mu_P_MIA = 24;
const int mu_P_EIA = 25;
const int mu_P_SIA = 26;
const int mu_P_IIA = 27;
const int mu_GetM = 28;
const int mu_GetMAck = 29;
const int mu_GetS = 30;
const int mu_GetSAck = 31;
const int mu_FwdGetM = 32;
const int mu_FwdGetS = 33;
const int mu_Inv = 34;
const int mu_InvAck = 35;
const int mu_PutM = 36;
const int mu_PutE = 37;
const int mu_PutS = 38;
const int mu_PutAck = 39;
const int mu_InvAckAll = 40;
const int mu_EAck = 41;
...
/*** Variable declaration ***/
mu_1_Node mu_to_be_sharer("to_be_sharer",1208);

/*** Variable declaration ***/
mu_1_Value mu_LastWrite("LastWrite",1216);
...
bool mu__boolexpr20;
  if ((mu_msg.mu_mtype) == (mu_InvAck)) mu__boolexpr20 = TRUE ;
  else {
bool mu__boolexpr21;
  if (!((mu_msg.mu_mtype) == (mu_GetMAck))) mu__boolexpr21 = FALSE ;
  else {
...
/*** end multisetcount 9 declaration ***/
  mu__boolexpr21 = ((mu__intexpr22) != (0)) ; 
}
...
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr23;
  if (!((mu_n>=1 && mu_n<=3))) mu__boolexpr23 = FALSE ;
  else {
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_HomeNode.mu_sharers.valid[(int)mu_i].value())
        {
          if ( (mu_HomeNode.mu_sharers[mu_i]) == (mu_n) ) mu__intexpr24++;
        }
      if (mu_i == 3-1) break;
    }
  }
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_sharers_copy.valid[(int)mu_i].value())
        {
          if ( (mu_sharers_copy[mu_i]) == (mu_n) ) mu__intexpr25++;
        }
      if (mu_i == 3-1) break;
    }
  }
...
/*** end multisetremove 1 declaration ***/
  mu_1__type_6_id mu__idexpr26;
  mu_1__type_6_id mu_i;
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_sharers_copy.valid[(int)mu_i].value())
        {
          if ( (mu_sharers_copy[mu_i]) == (mu_n) ) { mu__idexpr26 = mu_i; mu_sharers_copy.multisetremove(mu__idexpr26); };
        }
      if (mu_i == 3-1) break;
    }
/*** end multisetremove 1 declaration ***/
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_HomeNode.mu_sharers.valid[(int)mu_i].value())
        {
          if ( (mu_HomeNode.mu_sharers[mu_i]) == (mu_msg.mu_src) ) mu__intexpr28++;
        }
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 13 declaration ***/
mu_is_source = mu__intexpr28;
...
bool Condition(unsigned r)
{
  ...
  if (r>=37 && r<=42) return R5.Condition(r-37);
  if (r>=43 && r<=45) return R6.Condition(r-43);
  if (r>=46 && r<=48) return R7.Condition(r-46);
...
void Code(unsigned r)
{
  ...
  if (r>=37 && r<=42) { R5.Code(r-37); return; } 
  if (r>=43 && r<=45) { R6.Code(r-43); return; } 
  if (r>=46 && r<=48) { R7.Code(r-46); return; } 
...
int Priority(unsigned short r)
{
  ...
  if (r>=37 && r<=42) { return R5.Priority(); } 
  if (r>=43 && r<=45) { return R6.Priority(); } 
  if (r>=46 && r<=48) { return R7.Priority(); } 
...
char * Name(unsigned r)
{
  ...
  if (r>=37 && r<=42) return R5.Name(r-37);
  if (r>=43 && r<=45) return R6.Name(r-43);
  if (r>=46 && r<=48) return R7.Name(r-46);
  if (r>=49 && r<=51) return R8.Name(r-49);
  if (r>=52 && r<=54) return R9.Name(r-52);
  return NULL;
}
};
const unsigned numrules = 55;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 55
...
/********************
  Invariant records
 ********************/
int mu__invariant_29() // Invariant "values in shared state match memory"
{
bool mu__quant30; 
mu__quant30 = TRUE;
{
...
bool mu__boolexpr31;
bool mu__boolexpr32;
  if (!((mu_HomeNode.mu_state) == (mu_H_E))) mu__boolexpr32 = FALSE ;
  else {
  mu__boolexpr32 = ((mu_Procs[mu_n].mu_state) == (mu_P_E)) ; 
}
  if (!(mu__boolexpr32)) mu__boolexpr31 = TRUE ;
  else {
  mu__boolexpr31 = ((mu_HomeNode.mu_val) == (mu_Procs[mu_n].mu_val)) ; 
}
if ( !(mu__boolexpr31) )
...
bool mu__condition_33() // Condition for Rule "values in shared state match memory"
{
...
int mu__invariant_34() // Invariant "values in memory matches value of last write, when in P_E"
{
bool mu__quant35; 
mu__quant35 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr36;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_E))) mu__boolexpr36 = TRUE ;
  else {
  mu__boolexpr36 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr36) )
...
bool mu__condition_37() // Condition for Rule "values in memory matches value of last write, when in P_E"
{
...
int mu__invariant_38() // Invariant "values in memory matches value of last write, when shared or invalid"
{
bool mu__quant39; 
mu__quant39 = TRUE;
{
...
bool mu__boolexpr40;
bool mu__boolexpr41;
  if ((mu_HomeNode.mu_state) == (mu_H_S)) mu__boolexpr41 = TRUE ;
  else {
  mu__boolexpr41 = ((mu_HomeNode.mu_state) == (mu_H_I)) ; 
}
  if (!(mu__boolexpr41)) mu__boolexpr40 = TRUE ;
  else {
  mu__boolexpr40 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr40) )
...
bool mu__condition_42() // Condition for Rule "values in memory matches value of last write, when shared or invalid"
{
...
int mu__invariant_43() // Invariant "values in shared state match memory"
{
bool mu__quant44; 
mu__quant44 = TRUE;
{
...
bool mu__boolexpr45;
bool mu__boolexpr46;
  if (!((mu_HomeNode.mu_state) == (mu_H_S))) mu__boolexpr46 = FALSE ;
  else {
  mu__boolexpr46 = ((mu_Procs[mu_n].mu_state) == (mu_P_S)) ; 
}
  if (!(mu__boolexpr46)) mu__boolexpr45 = TRUE ;
  else {
  mu__boolexpr45 = ((mu_HomeNode.mu_val) == (mu_Procs[mu_n].mu_val)) ; 
}
if ( !(mu__boolexpr45) )
...
bool mu__condition_47() // Condition for Rule "values in shared state match memory"
{
...
{
bool mu__boolexpr49;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr49 = TRUE ;
  else {
...
int mu__invariant_52() // Invariant "modified and exclusive implies empty sharers list"
{
bool mu__boolexpr53;
bool mu__boolexpr54;
  if ((mu_HomeNode.mu_state) == (mu_H_M)) mu__boolexpr54 = TRUE ;
  else {
  mu__boolexpr54 = ((mu_HomeNode.mu_state) == (mu_H_E)) ; 
}
...
/*** end multisetcount 14 declaration ***/
  mu__boolexpr53 = ((mu__intexpr55) == (0)) ; 
}
return mu__boolexpr53;
};

bool mu__condition_56() // Condition for Rule "modified and exclusive implies empty sharers list"
{
...
int mu__invariant_57() // Invariant "values in valid state match last write"
{
bool mu__quant58; 
mu__quant58 = TRUE;
{
...
bool mu__boolexpr59;
bool mu__boolexpr60;
  if ((mu_Procs[mu_n].mu_state) == (mu_P_M)) mu__boolexpr60 = TRUE ;
  else {
  mu__boolexpr60 = ((mu_Procs[mu_n].mu_state) == (mu_P_E)) ; 
}
  if (!(mu__boolexpr60)) mu__boolexpr59 = TRUE ;
  else {
  mu__boolexpr59 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr59) )
...
bool mu__condition_61() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_62() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr63;
...
bool mu__condition_64() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_65() // Invariant "value is undefined while invalid"
{
bool mu__quant66; 
mu__quant66 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr67;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_I))) mu__boolexpr67 = TRUE ;
  else {
  mu__boolexpr67 = (mu_Procs[mu_n].mu_val.isundefined()) ; 
}
if ( !(mu__boolexpr67) )
...
bool mu__condition_68() // Condition for Rule "value is undefined while invalid"
{
...
int mu__invariant_69() // Invariant "Invalid implies empty owner"
{
bool mu__boolexpr70;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr70 = TRUE ;
  else {
  mu__boolexpr70 = (mu_HomeNode.mu_owner.isundefined()) ; 
}
...
{"Invalid implies empty owner", &mu__condition_71, NULL, FALSE},
{"value is undefined while invalid", &mu__condition_68, NULL, FALSE},
{"value in memory matches value of last write, when invalid", &mu__condition_64, NULL, FALSE},
{"values in valid state match last write", &mu__condition_61, NULL, FALSE},
{"modified and exclusive implies empty sharers list", &mu__condition_56, NULL, FALSE},
{"Invalid implies empty sharer list", &mu__condition_51, NULL, FALSE},
{"values in shared state match memory", &mu__condition_47, NULL, FALSE},
{"values in memory matches value of last write, when shared or invalid", &mu__condition_42, NULL, FALSE},
{"values in memory matches value of last write, when in P_E", &mu__condition_37, NULL, FALSE},
{"values in shared state match memory", &mu__condition_33, NULL, FALSE},
};
