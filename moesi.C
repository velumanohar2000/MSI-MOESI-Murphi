/******************************
  Program "moesi.m" compiled by "Murphi Release 3.1"

  Murphi Last Modefied Date: "Jan 29 1999"
  Murphi Last Compiled date: "Mar  7 2025"
 ******************************/
...
#define PROTOCOL_NAME "moesi"
#define BITS_IN_WORLD 1232
#define ALIGN
...
class mu_1_h_state: public mu__byte
{
 public:
  inline int operator=(int val) { return value(val); };
  inline int operator=(const mu_1_h_state& val) { return value(val.value()); };
  static char *values[];
  friend ostream& operator<< (ostream& s, mu_1_h_state& val)
  {
    if (val.defined())
      return ( s << mu_1_h_state::values[ int(val) - 7] );
    else return ( s << "Undefined" );
  };

  mu_1_h_state (char *name, int os): mu__byte(7, 18, 4, name, os) {};
  mu_1_h_state (void): mu__byte(7, 18, 4) {};
  mu_1_h_state (int val): mu__byte(7, 18, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1_h_state::values[] = {"H_I","H_S","H_M","H_E","H_O","H_MSD","H_MMD","H_SMA","H_IE","H_MOD","H_OMA","H_OOD",NULL };

/*** end of enum declaration ***/
mu_1_h_state mu_1_h_state_undefined_var;

class mu_1_p_state: public mu__byte
{
 public:
  inline int operator=(int val) { return value(val); };
  inline int operator=(const mu_1_p_state& val) { return value(val.value()); };
  static char *values[];
  friend ostream& operator<< (ostream& s, mu_1_p_state& val)
  {
    if (val.defined())
      return ( s << mu_1_p_state::values[ int(val) - 19] );
    else return ( s << "Undefined" );
  };

  mu_1_p_state (char *name, int os): mu__byte(19, 35, 5, name, os) {};
  mu_1_p_state (void): mu__byte(19, 35, 5) {};
  mu_1_p_state (int val): mu__byte(19, 35, 5, "Parameter or function result.", 0)
  {
     operator=(val);
  };
  char * Name() { return values[ value() -19]; };
  virtual void Permute(PermSet& Perm, int i);
  virtual void SimpleCanonicalize(PermSet& Perm);
  virtual void Canonicalize(PermSet& Perm);
  virtual void SimpleLimit(PermSet& Perm);
...
char *mu_1_p_state::values[] = {"P_I","P_S","P_M","P_E","P_O","P_ISD","P_IMAD","P_IMA","P_SMAD","P_SMA","P_MIA","P_EIA","P_OMAC","P_OMA","P_OIA","P_SIA","P_IIA",NULL };

/*** end of enum declaration ***/
mu_1_p_state mu_1_p_state_undefined_var;
...
class mu_1_MessageType: public mu__byte
{
 public:
  ...
  {
    if (val.defined())
      return ( s << mu_1_MessageType::values[ int(val) - 36] );
    else return ( s << "Undefined" );
  };

  mu_1_MessageType (char *name, int os): mu__byte(36, 50, 4, name, os) {};
  mu_1_MessageType (void): mu__byte(36, 50, 4) {};
  mu_1_MessageType (int val): mu__byte(36, 50, 4, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
char *mu_1_MessageType::values[] = {"GetM","GetMAck","GetS","GetSAck","FwdGetM","FwdGetS","Inv","InvAck","PutM","PutE","PutO","PutS","PutAck","InvAckAll","EAck",NULL };
...
class mu_1__type_0_id: public mu__byte
{
 public:
  ...
  inline operator int() const { return value(); };
  mu_1__type_0_id () : mu__byte(0,2,0) {};
  mu_1__type_0_id (int val) : mu__byte(0,2,0, "Parameter or function result.",0) {operator=(val); };
  char * Name() { return tsprintf("%d", value()); };
};
class mu_1__type_0
{
...
class mu_1_HomeState
{
 public:
  ...
  void set_self_ar( char *n, char *n2, int os);
  void set_self(char *n, int os);
  mu_1_h_state mu_state;
  mu_1_Node mu_owner;
  mu_1__type_0 mu_sharers;
  mu_1_Value mu_val;
...
class mu_1__type_6_id: public mu__byte
{
 public:
  ...
  inline operator int() const { return value(); };
  mu_1__type_6_id () : mu__byte(0,2,0) {};
  mu_1__type_6_id (int val) : mu__byte(0,2,0, "Parameter or function result.",0) {operator=(val); };
  char * Name() { return tsprintf("%d", value()); };
};
class mu_1__type_6
{
...
const int mu_H_E = 10;
const int mu_H_O = 11;
const int mu_H_MSD = 12;
const int mu_H_MMD = 13;
const int mu_H_SMA = 14;
const int mu_H_IE = 15;
const int mu_H_MOD = 16;
const int mu_H_OMA = 17;
const int mu_H_OOD = 18;
const int mu_P_I = 19;
const int mu_P_S = 20;
const int mu_P_M = 21;
const int mu_P_E = 22;
const int mu_P_O = 23;
const int mu_P_ISD = 24;
const int mu_P_IMAD = 25;
const int mu_P_IMA = 26;
const int mu_P_SMAD = 27;
const int mu_P_SMA = 28;
const int mu_P_MIA = 29;
const int mu_P_EIA = 30;
const int mu_P_OMAC = 31;
const int mu_P_OMA = 32;
const int mu_P_OIA = 33;
const int mu_P_SIA = 34;
const int mu_P_IIA = 35;
const int mu_GetM = 36;
const int mu_GetMAck = 37;
const int mu_GetS = 38;
const int mu_GetSAck = 39;
const int mu_FwdGetM = 40;
const int mu_FwdGetS = 41;
const int mu_Inv = 42;
const int mu_InvAck = 43;
const int mu_PutM = 44;
const int mu_PutE = 45;
const int mu_PutO = 46;
const int mu_PutS = 47;
const int mu_PutAck = 48;
const int mu_InvAckAll = 49;
const int mu_EAck = 50;
/*** Variable declaration ***/
mu_1_HomeState mu_HomeNode("HomeNode",0);

/*** Variable declaration ***/
mu_1__type_1 mu_Procs("Procs",72);

/*** Variable declaration ***/
mu_1__type_3 mu_Net("Net",120);

/*** Variable declaration ***/
mu_1__type_5 mu_InBox("InBox",760);

/*** Variable declaration ***/
mu_0_boolean mu_msg_processed("msg_processed",1144);

/*** Variable declaration ***/
mu_1__type_6 mu_sharers_copy("sharers_copy",1152);

/*** Variable declaration ***/
mu_1_Node mu_to_be_owner("to_be_owner",1200);

/*** Variable declaration ***/
mu_0_boolean mu_upgraded_to_m("upgraded_to_m",1208);

/*** Variable declaration ***/
mu_1_Node mu_to_be_sharer("to_be_sharer",1216);

/*** Variable declaration ***/
mu_1_Value mu_LastWrite("LastWrite",1224);
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_HomeNode.mu_sharers.valid[(int)mu_i].value())
        {
          if ( (mu_HomeNode.mu_sharers[mu_i]) == (mu_n) ) mu__intexpr12++;
        }
      if (mu_i == 3-1) break;
    }
  }
...
bool mu__boolexpr14;
  if (!((mu_n>=1 && mu_n<=3))) mu__boolexpr14 = FALSE ;
  else {
...
/*** end multisetcount 3 declaration ***/
  mu__boolexpr14 = ((mu__intexpr15) != (0)) ; 
}
if ( mu__boolexpr14 )
{
if ( (mu_n) != (mu_rqst) )
{
mu_Send ( mu_Inv, mu_n, mu_rqst, mu_VC2, mu_1_Value_undefined_var );
}
}
};
};
...
void mu_MultiSetCount_HP(const mu_1_Proc& mu_p, const mu_1_p_state& mu_p1, const mu_1_p_state& mu_p2)
{
...
if ( (mu__intexpr16) == (0) )
{
if (mu_p1.isundefined())
  mu_Procs[mu_p].mu_state.undefine();
else
  mu_Procs[mu_p].mu_state = mu_p1;
mu_upgraded_to_m = mu_false;
mu_Send ( mu_EAck, (int)mu_HomeType, (int)mu_p, mu_VC0, mu_1_Value_undefined_var );
}
else
{
if (mu_p2.isundefined())
  mu_Procs[mu_p].mu_state.undefine();
else
  mu_Procs[mu_p].mu_state = mu_p2;
}
};
/*** end procedure declaration ***/

void mu_MultiSetCount_H(const mu_1_h_state& mu_h1, const mu_1_h_state& mu_h2)
{
...
if ( (mu__intexpr17) == (0) )
{
if (mu_h1.isundefined())
  mu_HomeNode.mu_state.undefine();
else
  mu_HomeNode.mu_state = mu_h1;
}
else
{
if (mu_h2.isundefined())
  mu_HomeNode.mu_state.undefine();
else
  mu_HomeNode.mu_state = mu_h2;
}
};
/*** end procedure declaration ***/

void mu_MultiSetCount_H_ADD(const mu_1_h_state& mu_h1, const mu_1_h_state& mu_h2, mu_1_Message& mu_msg)
{
...
void mu_MultiSetCount_H_PutS(const mu_1_h_state& mu_h1, const mu_1_h_state& mu_h2)
{
...
void mu_MultiSetCount_P(const mu_1_Proc& mu_p, const mu_1_p_state& mu_ps1, const mu_1_p_state& mu_ps2, mu_1_Message& mu_msg)
{
/*** begin multisetcount 8 declaration ***/
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_sharers_copy.valid[(int)mu_i].value())
        {
...
if ( (mu__intexpr20) == (0) )
{
if (mu_ps1.isundefined())
  mu_Procs[mu_p].mu_state.undefine();
else
  mu_Procs[mu_p].mu_state = mu_ps1;
bool mu__boolexpr21;
  if ((mu_msg.mu_mtype) == (mu_InvAck)) mu__boolexpr21 = TRUE ;
  else {
bool mu__boolexpr22;
  if (!((mu_msg.mu_mtype) == (mu_GetMAck))) mu__boolexpr22 = FALSE ;
  else {
...
/*** end multisetcount 9 declaration ***/
  ...
  mu__boolexpr21 = (mu__boolexpr22) ; 
}
if ( mu__boolexpr21 )
{
mu_Send ( mu_InvAckAll, (int)mu_HomeType, (int)mu_p, mu_VC0, mu_1_Value_undefined_var );
}
}
else
{
if (mu_ps2.isundefined())
  mu_Procs[mu_p].mu_state.undefine();
else
  mu_Procs[mu_p].mu_state = mu_ps2;
}
};
/*** end procedure declaration ***/

void mu_CopySharersList(const mu_1_Node& mu_rqst)
{
{
for(int mu_n = 1; mu_n <= 6; mu_n++)
  if (( ( mu_n >= 1 ) && ( mu_n <= 3 ) )|| ( ( mu_n >= 6 ) && ( mu_n <= 6 ) )) {
bool mu__boolexpr24;
  if (!((mu_n>=1 && mu_n<=3))) mu__boolexpr24 = FALSE ;
  else {
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_HomeNode.mu_sharers.valid[(int)mu_i].value())
        {
          if ( (mu_HomeNode.mu_sharers[mu_i]) == (mu_n) ) mu__intexpr25++;
        }
      if (mu_i == 3-1) break;
    }
  }
...
if ( (mu_n) != (mu_rqst) )
{
mu_sharers_copy.multisetadd(mu_n);
}
}
};
};
...
void mu_RemoveFromSharersCopyList(const mu_1_Node& mu_n)
{
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_sharers_copy.valid[(int)mu_i].value())
        {
          if ( (mu_sharers_copy[mu_i]) == (mu_n) ) mu__intexpr26++;
        }
      if (mu_i == 3-1) break;
    }
  }
...
/*** end multisetremove 1 declaration ***/
  mu_1__type_6_id mu__idexpr27;
  mu_1__type_6_id mu_i;
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_sharers_copy.valid[(int)mu_i].value())
        {
          if ( (mu_sharers_copy[mu_i]) == (mu_n) ) { mu__idexpr27 = mu_i; mu_sharers_copy.multisetremove(mu__idexpr27); };
        }
      if (mu_i == 3-1) break;
    }
/*** end multisetremove 1 declaration ***/
...
{
/*** Variable declaration ***/
mu_1__type_7 mu_cnt_sharers("cnt_sharers",0);

/*** Variable declaration ***/
mu_1__type_8 mu_is_source("is_source",8);
  ...
  for (mu_i = 0; ; mu_i=mu_i+1)
    {
      if (mu_HomeNode.mu_sharers.valid[(int)mu_i].value())
        {
          if ( (mu_HomeNode.mu_sharers[mu_i]) == (mu_msg.mu_src) ) mu__intexpr29++;
        }
      if (mu_i == 3-1) break;
    }
  }
/*** end multisetcount 13 declaration ***/
mu_is_source = mu__intexpr29;
mu_msg_processed = mu_true;
switch ((int) mu_HomeNode.mu_state) {
case mu_H_I:
switch ((int) mu_msg.mu_mtype) {
case mu_GetS:
mu_Send ( mu_GetSAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC0, mu_HomeNode.mu_val );
mu_MultiSetCount_H_ADD ( mu_H_IE, mu_H_S, mu_msg );
break;
case mu_GetM:
...
break;
case mu_PutM:
if ( !((mu_msg.mu_src) != (mu_HomeNode.mu_owner)) ) Error.Error("Assertion failed: Can't receive PutM+data from Owner");
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC2, mu_1_Value_undefined_var );
break;
case mu_PutE:
if ( !((mu_msg.mu_src) != (mu_HomeNode.mu_owner)) ) Error.Error("Assertion failed: Can't receive PutE+data from Owner");
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC2, mu_1_Value_undefined_var );
break;
case mu_PutO:
if ( !((mu_msg.mu_src) != (mu_HomeNode.mu_owner)) ) Error.Error("Assertion failed: Can't receive PutO+data from Owner");
mu_Send ( mu_PutAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC2, mu_1_Value_undefined_var );
break;
default:
...
break;
case mu_H_M:
if ( !((mu_HomeNode.mu_owner.isundefined()) == (mu_false)) ) Error.Error("Assertion failed: HomeNode has no owner, but line is in Modified State");
switch ((int) mu_msg.mu_mtype) {
case mu_GetS:
mu_Send ( mu_FwdGetS, mu_HomeNode.mu_owner, mu_msg.mu_src, mu_VC2, mu_1_Value_undefined_var );
mu_to_be_sharer = mu_msg.mu_src;
mu_HomeNode.mu_state = mu_H_MOD;
break;
case mu_GetM:
...
case mu_GetS:
mu_Send ( mu_FwdGetS, mu_HomeNode.mu_owner, mu_msg.mu_src, mu_VC2, mu_1_Value_undefined_var );
mu_HomeNode.mu_state = mu_H_OOD;
mu_to_be_sharer = mu_msg.mu_src;
break;
case mu_GetM:
if ( (mu_msg.mu_src) == (mu_HomeNode.mu_owner) )
{
mu_Send ( mu_GetMAck, mu_msg.mu_src, (int)mu_HomeType, mu_VC2, mu_1_Value_undefined_var );
mu_CopySharersList ( mu_msg.mu_src );
mu_SendInvReqToSharers ( mu_msg.mu_src );
mu_HomeNode.mu_state = mu_H_SMA;
}
...
break;
case mu_GetSAck:
mu_AddToSharersList ( mu_to_be_sharer );
mu_to_be_sharer.undefine();
mu_HomeNode.mu_state = mu_H_O;
break;
default:
mu_ErrorUnhandledMsg ( mu_msg, (int)mu_HomeType );
break;
...
{
/*** Variable declaration ***/
mu_1__type_9 mu_cnt_sharers("cnt_sharers",0);
...
mu_cnt_sharers = mu__intexpr30;
mu_msg_processed = mu_true;
{
  mu_1_p_state& mu_ps = mu_Procs[mu_p].mu_state;
{
...
{
mu_MultiSetCount_HP ( mu_p, mu_P_E, mu_P_S );
}
else
{
mu_ps = mu_P_S;
...
break;
case mu_GetMAck:
mu_MultiSetCount_P ( mu_p, mu_P_M, mu_P_IMA, mu_msg );
mu_pv = mu_msg.mu_val;
break;
case mu_InvAck:
mu_RemoveFromSharersCopyList ( mu_msg.mu_src );
break;
default:
mu_ErrorUnhandledMsg ( mu_msg, (int)mu_p );
break;
...
switch ((int) mu_msg.mu_mtype) {
case mu_Inv:
mu_Send ( mu_InvAck, mu_msg.mu_src, (int)mu_p, mu_VC0, mu_1_Value_undefined_var );
mu_pv.undefine();
mu_ps = mu_P_I;
break;
default:
...
break;
case mu_GetMAck:
mu_MultiSetCount_P ( mu_p, mu_P_M, mu_P_SMA, mu_msg );
mu_pv = mu_msg.mu_val;
break;
case mu_InvAck:
mu_RemoveFromSharersCopyList ( mu_msg.mu_src );
...
switch ((int) mu_msg.mu_mtype) {
case mu_FwdGetS:
mu_Send ( mu_GetSAck, mu_msg.mu_src, (int)mu_p, mu_VC0, mu_pv );
mu_Send ( mu_GetSAck, (int)mu_HomeType, (int)mu_p, mu_VC0, mu_pv );
mu_ps = mu_P_O;
break;
case mu_FwdGetM:
...
break;
case mu_GetMAck:
mu_MultiSetCount_P ( mu_p, mu_P_M, mu_P_OMA, mu_msg );
if ( (mu_cnt_sharers) == (0) )
{
mu_ps = mu_P_M;
mu_Send ( mu_InvAckAll, (int)mu_HomeType, (int)mu_p, mu_VC0, mu_1_Value_undefined_var );
...
void world_class::clear()
{
  ...
  mu_sharers_copy.clear();
  mu_to_be_owner.clear();
  mu_upgraded_to_m.clear();
  mu_to_be_sharer.clear();
  mu_LastWrite.clear();
}
void world_class::undefine()
{
  ...
  mu_sharers_copy.undefine();
  mu_to_be_owner.undefine();
  mu_upgraded_to_m.undefine();
  mu_to_be_sharer.undefine();
...
void world_class::reset()
{
  ...
  mu_sharers_copy.reset();
  mu_to_be_owner.reset();
  mu_upgraded_to_m.reset();
  mu_to_be_sharer.reset();
  mu_LastWrite.reset();
}
void world_class::print()
{
  ...
  mu_sharers_copy.print();
  mu_to_be_owner.print();
  mu_upgraded_to_m.print();
  mu_to_be_sharer.print();
  mu_LastWrite.print();
    num_calls--;
}
}
void world_class::print_statistic()
{
  ...
  mu_sharers_copy.print_statistic();
  mu_to_be_owner.print_statistic();
  mu_upgraded_to_m.print_statistic();
  mu_to_be_sharer.print_statistic();
...
void world_class::print_diff( state *prevstate )
{
  if ( prevstate != NULL )
  {
    ...
    mu_sharers_copy.print_diff(prevstate);
    mu_to_be_owner.print_diff(prevstate);
    mu_upgraded_to_m.print_diff(prevstate);
    mu_to_be_sharer.print_diff(prevstate);
...
void world_class::to_state(state *newstate)
{
  ...
  mu_sharers_copy.to_state( newstate );
  mu_to_be_owner.to_state( newstate );
  mu_upgraded_to_m.to_state( newstate );
  mu_to_be_sharer.to_state( newstate );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Replacement - from P_O, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_PutO, (int)mu_HomeType, (int)mu_n, mu_VC1, mu_p.mu_val );
mu_p.mu_state = mu_P_OIA;
  };
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Store new value - from P_O, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_GetM, (int)mu_HomeType, (int)mu_n, mu_VC1, mu_1_Value_undefined_var );
mu_p.mu_state = mu_P_OMAC;
  };
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Replacement - from P_E, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_PutE, (int)mu_HomeType, (int)mu_n, mu_VC1, mu_1_Value_undefined_var );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Store new value - from P_E, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Replacement - from P_M, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_PutM, (int)mu_HomeType, (int)mu_n, mu_VC1, mu_p.mu_val );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Store new value - Only in P_M, v:%s, n:%s", mu_v.Name(), mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Value mu_v;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Replacement - from P_S, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_PutS, (int)mu_HomeType, (int)mu_n, mu_VC1, mu_p.mu_val );
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Store new value - from P_S, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Write request from P_I, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
...
public:
  ...
  char * Name(unsigned r)
  {
    ...
    mu_n.value((r % 3) + 1);
    r = r / 3;
    return tsprintf("Read request from P_I, n:%s", mu_n.Name());
  }
  bool Condition(unsigned r)
  {
    static mu_1_Proc mu_n;
  ...
  void Code(unsigned r)
  {
    ...
    r = r / 3;
  mu_1_ProcState& mu_p = mu_Procs[mu_n];
mu_Send ( mu_GetS, (int)mu_HomeType, (int)mu_n, mu_VC1, mu_1_Value_undefined_var );
...
void SetNextEnabledRule(unsigned & what_rule)
{
  ...
  if (what_rule>=43 && what_rule<49)
    { R7.NextRule(what_rule);
      if (what_rule<49) return; }
  if (what_rule>=49 && what_rule<52)
    { R8.NextRule(what_rule);
      if (what_rule<52) return; }
  if (what_rule>=52 && what_rule<55)
    { R9.NextRule(what_rule);
      if (what_rule<55) return; }
  if (what_rule>=55 && what_rule<58)
    { R10.NextRule(what_rule);
      if (what_rule<58) return; }
  if (what_rule>=58 && what_rule<61)
...
bool Condition(unsigned r)
{
  ...
  if (r>=43 && r<=48) return R7.Condition(r-43);
  if (r>=49 && r<=51) return R8.Condition(r-49);
  if (r>=52 && r<=54) return R9.Condition(r-52);
  if (r>=55 && r<=57) return R10.Condition(r-55);
  if (r>=58 && r<=60) return R11.Condition(r-58);
...
void Code(unsigned r)
{
  ...
  if (r>=43 && r<=48) { R7.Code(r-43); return; } 
  if (r>=49 && r<=51) { R8.Code(r-49); return; } 
  if (r>=52 && r<=54) { R9.Code(r-52); return; } 
  if (r>=55 && r<=57) { R10.Code(r-55); return; } 
  if (r>=58 && r<=60) { R11.Code(r-58); return; } 
}
int Priority(unsigned short r)
{
  ...
  if (r>=43 && r<=48) { return R7.Priority(); } 
  if (r>=49 && r<=51) { return R8.Priority(); } 
  if (r>=52 && r<=54) { return R9.Priority(); } 
  if (r>=55 && r<=57) { return R10.Priority(); } 
  if (r>=58 && r<=60) { return R11.Priority(); } 
}
char * Name(unsigned r)
{
  ...
  if (r>=43 && r<=48) return R7.Name(r-43);
  if (r>=49 && r<=51) return R8.Name(r-49);
  if (r>=52 && r<=54) return R9.Name(r-52);
  if (r>=55 && r<=57) return R10.Name(r-55);
  if (r>=58 && r<=60) return R11.Name(r-58);
  return NULL;
}
};
const unsigned numrules = 61;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 61
...
/********************
  Invariant records
 ********************/
int mu__invariant_31() // Invariant "values in shared state match memory"
{
bool mu__quant32; 
mu__quant32 = TRUE;
{
...
bool mu__boolexpr33;
bool mu__boolexpr34;
  if (!((mu_HomeNode.mu_state) == (mu_H_E))) mu__boolexpr34 = FALSE ;
  else {
  mu__boolexpr34 = ((mu_Procs[mu_n].mu_state) == (mu_P_E)) ; 
}
  if (!(mu__boolexpr34)) mu__boolexpr33 = TRUE ;
  else {
  mu__boolexpr33 = ((mu_HomeNode.mu_val) == (mu_Procs[mu_n].mu_val)) ; 
}
if ( !(mu__boolexpr33) )
...
bool mu__condition_35() // Condition for Rule "values in shared state match memory"
{
...
int mu__invariant_36() // Invariant "values in shared state match memory"
{
bool mu__quant37; 
mu__quant37 = TRUE;
{
...
bool mu__boolexpr38;
bool mu__boolexpr39;
  if (!((mu_HomeNode.mu_state) == (mu_H_O))) mu__boolexpr39 = FALSE ;
  else {
  mu__boolexpr39 = ((mu_Procs[mu_n].mu_state) == (mu_P_S)) ; 
}
  if (!(mu__boolexpr39)) mu__boolexpr38 = TRUE ;
  else {
  mu__boolexpr38 = ((mu_HomeNode.mu_val) == (mu_Procs[mu_n].mu_val)) ; 
}
if ( !(mu__boolexpr38) )
...
bool mu__condition_40() // Condition for Rule "values in shared state match memory"
{
...
int mu__invariant_41() // Invariant "values in memory matches value of last write, when in P_E"
{
bool mu__quant42; 
mu__quant42 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr43;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_E))) mu__boolexpr43 = TRUE ;
  else {
  mu__boolexpr43 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr43) )
...
bool mu__condition_44() // Condition for Rule "values in memory matches value of last write, when in P_E"
{
...
int mu__invariant_45() // Invariant "values in memory matches value of last write, when shared or invalid"
{
bool mu__quant46; 
mu__quant46 = TRUE;
{
...
bool mu__boolexpr47;
bool mu__boolexpr48;
  if ((mu_HomeNode.mu_state) == (mu_H_S)) mu__boolexpr48 = TRUE ;
  else {
  mu__boolexpr48 = ((mu_HomeNode.mu_state) == (mu_H_I)) ; 
}
  if (!(mu__boolexpr48)) mu__boolexpr47 = TRUE ;
  else {
  mu__boolexpr47 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr47) )
...
bool mu__condition_49() // Condition for Rule "values in memory matches value of last write, when shared or invalid"
{
...
int mu__invariant_50() // Invariant "values in shared state match memory"
{
bool mu__quant51; 
mu__quant51 = TRUE;
{
...
bool mu__boolexpr52;
bool mu__boolexpr53;
  if (!((mu_HomeNode.mu_state) == (mu_H_S))) mu__boolexpr53 = FALSE ;
  else {
  mu__boolexpr53 = ((mu_Procs[mu_n].mu_state) == (mu_P_S)) ; 
}
  if (!(mu__boolexpr53)) mu__boolexpr52 = TRUE ;
  else {
  mu__boolexpr52 = ((mu_HomeNode.mu_val) == (mu_Procs[mu_n].mu_val)) ; 
}
if ( !(mu__boolexpr52) )
...
bool mu__condition_54() // Condition for Rule "values in shared state match memory"
{
...
int mu__invariant_55() // Invariant "Invalid implies empty sharer list"
{
bool mu__boolexpr56;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr56 = TRUE ;
  else {
...
bool mu__condition_58() // Condition for Rule "Invalid implies empty sharer list"
{
...
int mu__invariant_59() // Invariant "modified and exclusive implies empty sharers list"
{
bool mu__boolexpr60;
bool mu__boolexpr61;
  if ((mu_HomeNode.mu_state) == (mu_H_M)) mu__boolexpr61 = TRUE ;
  else {
  mu__boolexpr61 = ((mu_HomeNode.mu_state) == (mu_H_E)) ; 
}
...
bool mu__condition_63() // Condition for Rule "modified and exclusive implies empty sharers list"
{
...
int mu__invariant_64() // Invariant "values in valid state match last write"
{
bool mu__quant65; 
mu__quant65 = TRUE;
{
...
bool mu__boolexpr66;
bool mu__boolexpr67;
  if ((mu_Procs[mu_n].mu_state) == (mu_P_M)) mu__boolexpr67 = TRUE ;
  else {
  mu__boolexpr67 = ((mu_Procs[mu_n].mu_state) == (mu_P_E)) ; 
}
  if (!(mu__boolexpr67)) mu__boolexpr66 = TRUE ;
  else {
  mu__boolexpr66 = ((mu_Procs[mu_n].mu_val) == (mu_LastWrite)) ; 
}
if ( !(mu__boolexpr66) )
...
bool mu__condition_68() // Condition for Rule "values in valid state match last write"
{
...
int mu__invariant_69() // Invariant "value in memory matches value of last write, when invalid"
{
bool mu__boolexpr70;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr70 = TRUE ;
  else {
  mu__boolexpr70 = ((mu_HomeNode.mu_val) == (mu_LastWrite)) ; 
}
return mu__boolexpr70;
};

bool mu__condition_71() // Condition for Rule "value in memory matches value of last write, when invalid"
{
...
int mu__invariant_72() // Invariant "value is undefined while invalid"
{
bool mu__quant73; 
mu__quant73 = TRUE;
{
for(int mu_n = 1; mu_n <= 3; mu_n++) {
bool mu__boolexpr74;
  if (!((mu_Procs[mu_n].mu_state) == (mu_P_I))) mu__boolexpr74 = TRUE ;
  else {
  mu__boolexpr74 = (mu_Procs[mu_n].mu_val.isundefined()) ; 
}
if ( !(mu__boolexpr74) )
...
bool mu__condition_75() // Condition for Rule "value is undefined while invalid"
{
...
{
bool mu__boolexpr77;
  if (!((mu_HomeNode.mu_state) == (mu_H_I))) mu__boolexpr77 = TRUE ;
  else {
...
{"value is undefined while invalid", &mu__condition_75, NULL, FALSE},
{"value in memory matches value of last write, when invalid", &mu__condition_71, NULL, FALSE},
{"values in valid state match last write", &mu__condition_68, NULL, FALSE},
{"modified and exclusive implies empty sharers list", &mu__condition_63, NULL, FALSE},
{"Invalid implies empty sharer list", &mu__condition_58, NULL, FALSE},
{"values in shared state match memory", &mu__condition_54, NULL, FALSE},
{"values in memory matches value of last write, when shared or invalid", &mu__condition_49, NULL, FALSE},
{"values in memory matches value of last write, when in P_E", &mu__condition_44, NULL, FALSE},
{"values in shared state match memory", &mu__condition_40, NULL, FALSE},
{"values in shared state match memory", &mu__condition_35, NULL, FALSE},
};
...
upgraded_to_m:NoScalarset
to_be_sharer:ScalarsetVariable
to_be_owner:ScalarsetVariable
LastWrite:ScalarsetVariable
InBox:ScalarsetArrayOfScalarset
Procs:ScalarsetArrayOfScalarset
HomeNode:Complex
Net:Complex
sharers_copy:Complex
*/
...
void SymmetryClass::MultisetSort(state* s)
{
        ...
        mu_upgraded_to_m.MultisetSort();
        mu_to_be_sharer.MultisetSort();
        mu_to_be_owner.MultisetSort();
        mu_LastWrite.MultisetSort();
        mu_InBox.MultisetSort();
        mu_Procs.MultisetSort();
        mu_HomeNode.MultisetSort();
        mu_Net.MultisetSort();
        mu_sharers_copy.MultisetSort();
}
...
void mu_1_h_state::Permute(PermSet& Perm, int i) {};
void mu_1_h_state::SimpleCanonicalize(PermSet& Perm) {};
void mu_1_h_state::Canonicalize(PermSet& Perm) {};
void mu_1_h_state::SimpleLimit(PermSet& Perm) {};
void mu_1_h_state::ArrayLimit(PermSet& Perm) {};
void mu_1_h_state::Limit(PermSet& Perm) {};
void mu_1_h_state::MultisetLimit(PermSet& Perm)
{ Error.Error("Internal: calling MultisetLimit for enum type.\n"); };
void mu_1_p_state::Permute(PermSet& Perm, int i) {};
void mu_1_p_state::SimpleCanonicalize(PermSet& Perm) {};
void mu_1_p_state::Canonicalize(PermSet& Perm) {};
void mu_1_p_state::SimpleLimit(PermSet& Perm) {};
void mu_1_p_state::ArrayLimit(PermSet& Perm) {};
void mu_1_p_state::Limit(PermSet& Perm) {};
void mu_1_p_state::MultisetLimit(PermSet& Perm)
{ Error.Error("Internal: calling MultisetLimit for enum type.\n"); };
  ...
  if (args->symmetry_reduction.value)
    {
      if (  args->sym_alg.mode == argsym_alg::Exhaustive_Fast_Canonicalize
          ...
          if (Perm.In(i))
            {
              ...
              if (args->multiset_reduction.value)
                mu_msg_processed.MultisetSort();
              mu_upgraded_to_m.Permute(Perm,i);
              if (args->multiset_reduction.value)
                mu_upgraded_to_m.MultisetSort();
              mu_to_be_sharer.Permute(Perm,i);
              if (args->multiset_reduction.value)
                mu_to_be_sharer.MultisetSort();
              mu_to_be_owner.Permute(Perm,i);
              if (args->multiset_reduction.value)
                mu_to_be_owner.MultisetSort();
              ...
              if (args->multiset_reduction.value)
                mu_Net.MultisetSort();
              mu_sharers_copy.Permute(Perm,i);
              if (args->multiset_reduction.value)
                mu_sharers_copy.MultisetSort();
        ...
        if (ns != workingstate)
          ...
          if (args->multiset_reduction.value)
            mu_msg_processed.MultisetSort();
          mu_upgraded_to_m.Permute(Perm,0);
          if (args->multiset_reduction.value)
            mu_upgraded_to_m.MultisetSort();
          mu_to_be_sharer.Permute(Perm,0);
          if (args->multiset_reduction.value)
            mu_to_be_sharer.MultisetSort();
          mu_to_be_owner.Permute(Perm,0);
          if (args->multiset_reduction.value)
            mu_to_be_owner.MultisetSort();
          ...
          if (args->multiset_reduction.value)
            mu_Net.MultisetSort();
          mu_sharers_copy.Permute(Perm,0);
          if (args->multiset_reduction.value)
            mu_sharers_copy.MultisetSort();
        if (p.compare(workingstate)) {
          StateCopy(workingstate,&temp); return TRUE; }
...
void SymmetryClass::Heuristic_Fast_Canonicalize(state* s)
{
  ...
  mu_to_be_sharer.SimpleCanonicalize(Perm);

  mu_to_be_owner.SimpleCanonicalize(Perm);
  ...
  if (Perm.MoreThanOneRemain()) {
    mu_sharers_copy.MultisetLimit(Perm);
  }
